...
namespace forest {
        ...
        struct binary_search_tree_node {
                 ...
                 */
                binary_search_tree_node(key_t key) {
                        this->key = key;
                        this->parent.reset();
                        this->left = nullptr;
                        this->right = nullptr;
        ...
        private:
                ...
                unsigned long long height(std::shared_ptr<binary_search_tree_node <key_t> > &x) {
                        if (x == nullptr) return 0;
                        return std::max(height(x->left), height(x->right)) + 1;
                }
                unsigned long long size(std::shared_ptr<binary_search_tree_node <key_t> > &x) {
                        if (x == nullptr) return 0;
        ...
        public:
                 ...
                 */
                const std::shared_ptr<binary_search_tree_node <key_t> > insert(key_t key) {
                 ...
                 */
                const std::shared_ptr<binary_search_tree_node <key_t> > search(key_t key) {
                 ...
                 */
                const std::shared_ptr<binary_search_tree_node <key_t> > successor(key_t key) {
                        std::shared_ptr<binary_search_tree_node <key_t> > x = root;
                        while (x != nullptr) {
                                if (key > x->key) {
                                        x = x->right;
                 ...
                 */
                const std::shared_ptr<binary_search_tree_node <key_t> > predecessor(key_t key) {
                        std::shared_ptr<binary_search_tree_node <key_t> > x = root;
                        while (x != nullptr) {
                                if (key > x->key) {
                                        x = x->right;
