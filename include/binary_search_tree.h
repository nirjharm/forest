...
namespace forest {
        ...
        public:
                 ...
                 */
                const std::shared_ptr<binary_search_tree_node <key_t, value_t> > successor(key_t key) {
                        std::shared_ptr<binary_search_tree_node <key_t, value_t> > x = root;
                        while (x != nullptr) {
                                if (key > x->key) {
                                        x = x->right;
                                        ...
                                        std::shared_ptr<binary_search_tree_node <key_t, value_t> > parent = x->parent.lock();
                 ...
                 */
                const std::shared_ptr<binary_search_tree_node <key_t, value_t> > predecessor(key_t key) {
                        std::shared_ptr<binary_search_tree_node <key_t, value_t> > x = root;
                        while (x != nullptr) {
                                if (key > x->key) {
                                        x = x->right;
